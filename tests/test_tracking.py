...
def test_tracker_assigns_ids(byte_tracker):
    ...
    d1 = Detection(
        bbox=BBox(0, 0, 10, 10), class_id=0, class_name="person", confidence=0.9, frame_id=1
    )
    d2 = Detection(
        bbox=BBox(20, 20, 30, 30), class_id=0, class_name="person", confidence=0.9, frame_id=1
    )
    byte_tracker.update([d1, d2])  # Frame 1 — tentative, not returned yet

    # Frame 2 — tracks now confirmed (min_hits satisfied)
    d1_f2 = Detection(
        bbox=BBox(1, 1, 11, 11), class_id=0, class_name="person", confidence=0.9, frame_id=2
    )
    d2_f2 = Detection(
        bbox=BBox(21, 21, 31, 31), class_id=0, class_name="person", confidence=0.9, frame_id=2
    )
    ...
    d1_f3 = Detection(
        bbox=BBox(2, 2, 12, 12), class_id=0, class_name="person", confidence=0.9, frame_id=3
    )
    d2_f3 = Detection(
        bbox=BBox(22, 22, 32, 32), class_id=0, class_name="person", confidence=0.9, frame_id=3
    )
...
def test_tracker_drops_lost_track(byte_tracker):
    ...
    d1_f2 = Detection(
        bbox=BBox(0, 0, 10, 10), class_id=0, class_name="person", confidence=0.9, frame_id=2
    )
    ...
    d1_f42 = Detection(
        bbox=BBox(0, 0, 10, 10), class_id=0, class_name="person", confidence=0.9, frame_id=42
    )
    byte_tracker.update([d1_f42])

    d1_f43 = Detection(
        bbox=BBox(0, 0, 10, 10), class_id=0, class_name="person", confidence=0.9, frame_id=43
    )
